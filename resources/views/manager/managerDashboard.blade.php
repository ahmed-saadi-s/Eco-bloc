            ...
            <tr>
                ...
                <td>
                    @if($order->status == 'Accepted')
                        <form action="{{ url('/updateOrderStatus/' . $order->id) }}" method="POST">
                            @csrf
                            <input type="hidden" name="order_status" value="Delivered">
                            <button type="submit" style="background-color: #27ae60; color: #fff; border: none; padding: 8px 12px; border-radius: 5px; cursor: pointer;">Delivered</button>
                        </form>

                        <form action="{{ url('/updateOrderStatus/' . $order->id) }}" method="POST">
                            @csrf
                            <input type="hidden" name="order_status" value="Rejected">
                            <button type="submit" style="background-color: #e74c3c; color: #fff; border: none; padding: 8px 12px; border-radius: 5px; cursor: pointer;">Rejected</button>
                        </form>
