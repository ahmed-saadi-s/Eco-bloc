                    ...
                    <div class="header__top__right">
                        @auth
                            ...
                            <div class="header__cart">
                                <ul>
                                    <li><a href="{{url('viewCart')}}"><i class="fa fa-shopping-bag"></i> <span>{{ count((array) session('cart')) }}</span>
                                        </a></li>
                                </ul>
                        ...
                        @if(auth()->check() && auth()->user()->role === 'manager')
                            <a href="{{url('managerDashboard')}}" class="btn btn-custom">Manager Dashboard</a>
