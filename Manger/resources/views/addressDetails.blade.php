    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            quantityTexts.forEach(text => {
                const quantity = parseFloat(text.textContent);
                const price = parseFloat(text.parentElement.nextElementSibling.textContent.replace('$', ''));
                const totalElement = text.parentElement.nextElementSibling.nextElementSibling;
