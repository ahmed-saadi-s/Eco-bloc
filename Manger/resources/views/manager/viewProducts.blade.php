...
<body>
<header>
    <h1>Product Management - View Product</h1>
</header>
<nav>
...
<script>
    function searchProduct() {
        ...
        // إذا كان الـ ID غير فارغ
        if (productId.trim() !== '') {
            // تحويل المستخدم إلى العنوان المطلوب مع الـ ID المدخل
            window.location.href = '/searchProductByID/' + productId;
        } else {
            // إذا كان الـ ID فارغًا، يمكنك إظهار رسالة تنبيهية أو تنفيذ إجراء آخر
    ...
    function deleteProduct(productId) {
        ...
        if (confirmDelete) {
            window.location.href = '/deleteProductByID/' + productId; // تغيير المسار حسب الحاجة
        }
    }
